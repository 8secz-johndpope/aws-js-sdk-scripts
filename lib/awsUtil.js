    ...
    return new Promise((resolve, reject) => {
        s3.listBuckets(function(err, data) {
            if (err) {
                ...
                let targetBucket = data.Buckets.find((bucket) => STAGE_BUCKETS.some((stageBucket) => bucket.Name.includes(stageBucket)));
...
exports.createCluster = function(envParams) {
    ...
    let newClusterParams = {
        ...
        BootstrapActions: [{
            ...
            ScriptBootstrapAction: {
                Path: envParams.RcS3StageDir + '/RC/' + envParams.env + '/hive-scripts/create_self_signed_keystore.sh'
            }
        }, {
            ...
            ScriptBootstrapAction: {
                Path: envParams.RcS3StageDir + '/RC/' + envParams.env + '/hive-scripts/set_hive_heapsize.rb',
                Args: [
            ...
            ScriptBootstrapAction: {
                Path: envParams.RcS3StageDir + '/RC/' + envParams.env + '/hive-scripts/fix_hive_split_size.sh'
            }
        }, {
            ...
            ScriptBootstrapAction: {
                Path: envParams.RcS3StageDir + '/RC/' + envParams.env + '/hive-scripts/copy_config_s3_files.sh'
            }
        }, {
            Name: 'InstallGanglia',
            ScriptBootstrapAction: {
